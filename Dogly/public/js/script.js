...
function arePasswordsSame(password, passwordConfirmation) {
...
countryInput.addEventListener('keyup', function () {
        setTimeout(function () {
                markValidation(countryInput, isCountry(countryInput.value))
            },
            1000
        );
    }
...
passwordConfirmationInput.addEventListener('keyup', function () {
        setTimeout(function () {
                markValidation(passwordConfirmationInput, arePasswordsSame(
                        passwordConfirmationInput.previousElementSibling.value,
...
function isCountryExist(country) {
    for (let i = 0; i < COUNTRIES.length; ++i) {
        if (country === COUNTRIES[i].name_en || country === COUNTRIES[i].name_pl) {
            return true;
        }
    }
    return false;
